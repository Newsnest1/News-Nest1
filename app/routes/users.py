...
@router.post("/users/me/follow/topic")
...
@router.delete("/users/me/follow/topic")
...
@router.get("/users/me/followed/topics")
...
@router.post("/users/me/follow/outlet")
...
@router.delete("/users/me/follow/outlet")
...
@router.get("/users/me/followed/outlets")
